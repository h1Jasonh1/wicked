...
export const metadata: Metadata = {
  title: "Terms of Service | SOO",
  description:
    "SOO terms of service for orders, pricing, product information, returns and account use.",
};
  ...
  return (
    <main className={styles.policyPage}>
      <section className={styles.policyHero}>
        ...
        <p>
          These terms frame how SOO handles orders, pricing, product
          information, returns, and customer account use.
        </p>
      </section>
      <section className={styles.policyGrid}>
        {[
          ["Orders", "Orders are accepted once payment is authorised and stock is confirmed. SOO may contact customers to resolve address or payment issues."],
